...
class LteSimulation(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            ...
            'GEOMETRY_FIELD': 'geom',
            'ID_FIELD': 'id',
            'SQL': 'select * from drivetest_and_simulations.simulation_lte_best_server'
        }
        ...
        alg_params = {
            ...
            'GEOMETRY_FIELD': 'geom',
            'ID_FIELD': 'id',
            'SQL': 'select * from drivetest_and_simulations.simulation_lte_rsrp'
        }
        ...
        alg_params = {
            ...
            'STYLE': 'C:\\Users\\macabrera\\Documents\\QGIS exports\\Optinet_QGIS_layers\\Table_Drivetest_and_Simulation\\simulation_lte_rsrp.qml'
        }
